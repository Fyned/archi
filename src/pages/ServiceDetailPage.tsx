...
const serviceImageAlts: Record<string, Record<string, string[]>> = {
  ...
  window: {
    fr: [
      ...
      'Fenêtre PVC blanc haute isolation thermique - Châssis professionnel',
      'Fenêtres sol-plafond aluminium grande luminosité',
      'Fenêtre PVC profil multi-chambres - Double vitrage isolant',
      'Fenêtres angle aluminium design moderne',
      'Fenêtre PVC détail finition - Menuiserie qualité Belgique',
    ],
    nl: [
      'Hoogwaardige thermische aluminium ramen - België',
      'PVC raam wit hoge thermische isolatie - Professioneel kozijn',
      'Vloer-tot-plafond aluminium ramen veel licht',
      'PVC raam meerkamerprofiel - Dubbel isolerend glas',
      'Hoek aluminium ramen modern design',
      'PVC raam detail afwerking - Kwaliteit schrijnwerk België',
    ],
    en: [
      'High-performance thermal aluminum windows - Belgium',
      'White PVC window high thermal insulation - Professional frame',
      'Floor-to-ceiling aluminum windows high brightness',
      'PVC window multi-chamber profile - Double insulating glass',
      'Corner aluminum windows modern design',
      'PVC window finish detail - Quality joinery Belgium',
    ],
    de: [
      'Hochleistungs-Thermik-Aluminiumfenster - Belgien',
      'Weißes PVC-Fenster hohe Wärmedämmung - Professioneller Rahmen',
      'Bodentiefe Aluminiumfenster hohe Helligkeit',
      'PVC-Fenster Mehrkammerprofil - Doppelt isolierendes Glas',
      'Eck-Aluminiumfenster modernes Design',
      'PVC-Fenster Finish-Detail - Qualitätstischlerei Belgien',
    ],
    tr: [
      'Yüksek performanslı termal alüminyum pencereler - Belçika',
      'Beyaz PVC pencere yüksek ısı yalıtımı - Profesyonel çerçeve',
      'Yerden tavana alüminyum pencereler yüksek parlaklık',
      'PVC pencere çok odalı profil - Çift yalıtımlı cam',
      'Köşe alüminyum pencereler modern tasarım',
      'PVC pencere detay finisaj - Kaliteli doğrama Belçika',
    ],
  },
  shutter: {
    fr: [
...
const serviceImages: Record<string, string[]> = {
  pergola: [
    '/images/pergola/pergola-hero.webp',
  ...
  carport: [
    ...
    '/images/carport/carport-entrance-gate.webp',
  ],
  window: [
    '/images/window/window-hero.webp',
    '/images/window/pvc-window-hero.png',
    '/images/window/window-floor-ceiling.webp',
    '/images/window/pvc-window-profile.png',
    '/images/window/window-corner.webp',
    '/images/window/pvc-window-detail.png',
  ],
  shutter: [
    '/images/shutter/shutter-hero.webp',
    '/images/shutter/shutter-exterior-closed.webp',
    '/images/shutter/shutter-exterior-half.webp',
    '/images/shutter/shutter-bedroom-interior.webp',
    '/images/shutter/shutter-security.webp',
    '/images/shutter/shutter-colors-variety.webp',
  ],
  garage: [
    '/images/garage/garage-hero.webp',
    '/images/garage/garage-sectional-wood.webp',
    '/images/garage/garage-sectional-white.webp',
    '/images/garage/garage-double-modern.webp',
    '/images/garage/garage-open-interior.webp',
    '/images/garage/garage-night-lights.webp',
  ],
}
